...
const About = () => {
    ...
    return <>
        <div id="aboutAnchor" className="aboutContainer container">
            <h1> ABOUT ME </h1>
            <div className="story">
                    <p className="animate__animated animate__fadeInLeft animate__delay-3s"> Hi, I'm Felix, a full stack web developer with a background in teaching music 
                    ...
                    <p className="animate__animated animate__fadeInLeft animate__delay-4s"> I enjoy working with the client side, creating accessible, inviting, and memorable 
                    ...
                    <p className="animate__animated animate__fadeInLeft animate__delay-5s"> Despite only starting to code in Mid-2021, building digital projects has become 
